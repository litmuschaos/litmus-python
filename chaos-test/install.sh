...
declare -a chaosexperiments=("chaostoolkit" "chaostoolkit-lib" "chaostoolkit-reporting")
...
declare -a chaos_litmus_packages=("chaos" "chaostoolkit-kubernetes" "chaostoolkit-aws")
