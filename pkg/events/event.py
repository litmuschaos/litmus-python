...
def CreateEvents(EventDetails, clients clients, ChaosDetails, kind, eventName):
	events := &apiv1.Event{
...
def GenerateEvents(eventsDetails *types.EventDetails, clients clients.ClientSets, chaosDetails *types.ChaosDetails, kind string) error {
