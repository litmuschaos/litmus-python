...
def GetENV(experimentDetails):
	...
	experimentDetails.ChaosPodName = os.getenv("POD_NAME", "litmusportal-frontend-698bcb686f-7wv9h")
	...
	experimentDetails.TargetPods = os.getenv("TARGET_PODS", "nginx-658f4cf99f-64s2s")
