...
def GetENV(experimentDetails):
	...
	experimentDetails.AppLabel = os.getenv("APP_LABEL", "component=litmusportal-frontend")
	...
	experimentDetails.ChaosPodName = os.getenv("POD_NAME", "litmusportal-frontend-5c96c9468c-rs5sq")
